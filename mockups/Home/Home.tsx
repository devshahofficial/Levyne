...
type HomeScreenProps = {
	...
	setChatList: (Chats: ChatItemType[], EmptyFirst?: boolean) => void;
...
class HomeScreen extends React.Component<HomeScreenProps, HomeScreenState> {
	...
	componentDidMount() {
		...
		ListWishlistProductIDs(this.props.AccessToken)
			...
			<View flex>
				...
				<Animated.View
					...
					<ScrollView
						...
						<Category
							...
							Image={
								'https://d32kprqn8e36ns.cloudfront.net/SJ0001.webp'
							}
						/>
						<Category
							title={'Women'}
							...
							Image={
								'https://d32kprqn8e36ns.cloudfront.net/FemaleHP.webp'
							}
						/>
						<Category
							title={'Fusion'}
							...
							Image={
								'https://d32kprqn8e36ns.cloudfront.net/HA0003.webp'
							}
						/>
						<Category
							title={'Ethnic'}
							...
							Image={
								'https://d32kprqn8e36ns.cloudfront.net/RS0017.webp'
							}
						/>
					</ScrollView>
				</Animated.View>
				...
				<Animated.ScrollView
					...
					<View row>
						<TouchableOpacity
							...
							<Image
								source={{
									uri:
										'https://d32kprqn8e36ns.cloudfront.net/MenLevyne-min.png',
								}}
								style={styles.img}
							/>
						</TouchableOpacity>
						<TouchableOpacity
							...
							<Image
								source={{
									uri:
										'https://d32kprqn8e36ns.cloudfront.net/WomenLevyne-min.png',
								}}
								style={styles.img}
							/>
						</TouchableOpacity>
					...
					<Rectangle
						...
						Image={
							'https://d32kprqn8e36ns.cloudfront.net/BlazersHPImages.webp'
						}
					/>
					<Rectangle
						onPress={() =>
						...
						Image={
							'https://d32kprqn8e36ns.cloudfront.net/LehngaHPImages.webp'
						}
					/>
					...
					<View row>
						<TouchableOpacity
							...
							<Image
								source={{
									uri:
										'https://d32kprqn8e36ns.cloudfront.net/Group-4188.jpg',
								}}
								style={styles.img}
							/>
						</TouchableOpacity>
						<TouchableOpacity
							...
							<Image
								source={{
									uri:
										'https://d32kprqn8e36ns.cloudfront.net/Group-4189.jpg',
								}}
								style={styles.img}
							/>
						</TouchableOpacity>
				...
				{this.state.PendingReviews.length ? (
					<Toast visible={true} position={'bottom'}>
						<View flex paddingB-20>
							<ScrollView
								horizontal={true}
								pagingEnabled={true}
								showsHorizontalScrollIndicator={false}>
								{this.state.PendingReviews.map(
									(
										item: { OrderID: number; Name: string },
										index: number,
									) => {
										...
										const CloseRatingToast = () =>
											this.CloseRatingToast(
												index,
												item.OrderID,
											);
										return (
...
const mapDispatchToProps = (
	dispatch: (arg0: { type: string; value: any; EmptyFirst?: any }) => void,
) => {
	return {
		setChatList: (ChatList: ChatItemType[], EmptyFirst?: boolean) =>
			dispatch({ type: 'setChatList', value: ChatList, EmptyFirst }),
		setWishlist: (Wishlist: Wishlist) =>
			dispatch({ type: 'setWishlist', value: Wishlist }),
		MarkBucketAsUnRead: (Buckets: number[], EmptyFirst?: boolean) =>
			dispatch({
				type: 'MarkBucketAsUnRead',
				value: Buckets,
				EmptyFirst,
			}),
	};
