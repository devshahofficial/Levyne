...
export const CameraIcon = (props) => {
    return (
<Svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" width={props.size} height={props.size}
    ...
    v11.6c0,6,4.8,10.8,10.8,10.8H374c7.2,0,13.6,2.8,18.4,7.6s7.6,11.2,7.6,18.4V328.8z" fill={props.Color}/>
    ...
    c14-14,33.2-22.4,54.4-22.4s40.4,8.8,54.4,22.4c14,14,22.4,33.2,22.4,54.4C287.6,250.8,278.8,270,264.8,284z" fill={props.Color}/>
        <Circle cx="352.8" cy="150" r="19.6" fill={props.Color}/>
    </G>
</Svg>
